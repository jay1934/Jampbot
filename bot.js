...
const http = require("http"); // website references
...
// this keeps the bot running 24/7 by pinging it every 5 minutes so it doesn't fall asleep
app.listen(process.env.PORT);
setInterval(() => {
  // sets ping interval to 280000 ms (5 minutes)
  http.get(`http://jampbot.glitch.me/`);
}, 280000);
