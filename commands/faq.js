...
module.exports = {
  ...
  execute(message, args) {
    ...
    const menuEmbed = new Discord.MessageEmbed()
      ...
      .addField("__**faq 6 / faq roles**__", "How to get rank roles");
    ...
    if (
      message.content === `${prefix}faq 1` ||
      message.content === `${prefix}faq register`
    ) {
      message.channel.send({ embed: registerEmbed });
    } else if (
      message.content === `${prefix}faq 2` ||
      message.content === `${prefix}faq website`
    ) {
      message.channel.send({ embed: websiteEmbed });
    } else if (
      message.content === `${prefix}faq 3` ||
      message.content === `${prefix}faq clears`
    ) {
      message.channel.send({ embed: clearsEmbed });
    } else if (
      message.content === `${prefix}faq 4` ||
      message.content === `${prefix}faq levels`
    ) {
      message.channel.send({ embed: levelsEmbed });
    } else if (
      message.content === `${prefix}faq 5` ||
      ...
      message.content === `${prefix}faq pin` ||
      message.content === `${prefix}faq pins`
    ) {
