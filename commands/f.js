module.exports = {
  ...
  lastMessage.react(F).then(() => lastMessage.react(FeelsBuzzyMan)).then(() => lastMessage.react(MonkaS)).then(() => lastMessage.react(NotLikeThis)).then(() => lastMessage.react(SadPog));
