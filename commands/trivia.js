...
let questions = [
  {
    ...
    correct: 1,
    time: 10000,
    cErr: "Incorrect. I can't believe you would say such a thing <:What:717592758436757514>"
  },
  {
    title:
  ...
  {
    title:
      "When was Mario Maker 2 released?",
    options: [
      "June 28th, 2018",
      "July 18th, 2018",
      "June 20th, 2018",
  ...
  async execute(message, args) {
    if (usedCommandRecently.has(message.author.id)) {
      ...
      const Embed = new MessageEmbed()
        .setTitle(q.title)
        .setAuthor(`Reply to this message with the correct question number! You have ${q.time/1000} seconds.`)
        .setDescription(
          q.options.map(opt => {
            i++;
            return `${i} - ${opt}\n`;
